...
%  clear all;
 ...
 function failuremodel_new(topology,k)
...
kx=0.15;    %Threshold for nodes inside network X(minimum fraction of neighbors that should be failed before a node can fail)
ky=0.15;    %Threshold for nodes inside network Y
kxy=0.25;   %Threshold for parents of nodes of network Y, that are member of network X
kyx=0.25;   %Threshold for parents of nodes of network X, that are member of network Y
Ax=adj_x;
Ay=adj_y;
Axy=adj_xy;
Ayx=adj_yx;
...
save(temp, "vector_n_fail_time" ,"vector_failed_low_degx", "vector_failed_low_degy" , "vector_failed_high_degx" ,"vector_failed_high_degy" , "vector_Dgr1_11", "vector_Dgr1_12" ,"vector_F1", "vector_F2", "vector_n_fail_time2" , "vector_failed_low_degx2", "vector_failed_low_degy2", "vector_failed_high_degx2", "vector_failed_high_degy2", "vector_Dgr1_21", "vector_Dgr1_22", "vector_S_time1", "vector_S_time2", "vector_n_fail_time7", "vector_failed_low_degy7", "vector_failed_high_degx7", "vector_failed_high_degy7", "vector_Dgr1_112", "vector_Dgr1_122", "vector_F7", "vector_S_time7",'-v7.3')
