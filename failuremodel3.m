...
p1=0.008; %the probability of having a link between nodes of network X
p2=0.008; %the probability of having a link between nodes of network Y
...
vector_failed_high_betx7=cell(1,100);N_failed
...
% adj_xy=zeros(n1,n2);
% adj_yx=zeros(n2,n1);
% max_degree_x=node_degree_order_x(1,497:500);
% max_degree_y=node_degree_order_y(1,497:500);
