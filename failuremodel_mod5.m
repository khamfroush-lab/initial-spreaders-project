...
temp = strcat("Hetero-scenari-11&12n=500",inter,"-",topology,"k=20%",".mat") ;
...
temp = strcat("Hetero-scenari-21&22n=500",inter,"-",topology,"k=20%",".mat") ;
